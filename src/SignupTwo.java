...
String formno;
    ...
    String incomeCategory[]={"Null","<1,50,000","<3,50,000","<6,50,000","Upto 10,00,000"};
    ...
    add(marital);
     ...
     String occupationValues[]={"Salaried","Self Employed","Buisnesses","Student","Retired","Others"};
    ...
    //jate duto button aksonge select na hoybtar jonno use hoche
